...
const FROM = process.env.EMAIL_FROM || 'FlutterOTA Pro - Enterprise Flutter over-the-air update management <noreply@example.com>';
const APP_NAME = 'FlutterOTA Pro - Enterprise Flutter over-the-air update management';
